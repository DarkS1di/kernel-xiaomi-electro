...
./scripts/config --file out/.config --enable CONFIG_BOARD_CITRUS
./scripts/config --file out/.config --disable CONFIG_BOARD_LIME
...
mkdir -p out/arch/arm64/boot/citrus/
mv out/arch/arm64/boot/dtbo.img out/arch/arm64/boot/citrus/dtbo.img
